        <div class="span10">
          <article class="blog-post">
            ...
            $data = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM tbl_user  WHERE username='$_SESSION[masuk]'")); 
              ...
              $hasil=mysqli_query($connect, "select * from tbl_soal WHERE id_soal='SAL005'");
              ...
              <form name="form1" method="post" action="proses5.php?idlamaran=<?php echo $data_pelamar['id_lamaran'];?>">
